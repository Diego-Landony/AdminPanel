...
describe('Combo Listing', function () {
    test('can list combos', function () {
    ...
    test('can search combos by name', function () {
    ...
    test('stats displays active and available combos correctly', function () {
        ...
        $response->assertInertia(fn ($page) => $page
            ...
            ->where('stats.available_combos', 1)
        );
    });
});

describe('Combo Creation', function () {
    test('can create combo with products', function () {
    ...
    test('can create combo with duplicate products in different quantities', function () {
        $product = Product::factory()->create();
        $category = Category::factory()->create(['is_combo_category' => true]);
...
describe('Combo Updates', function () {
    ...
    test('can change combo category', function () {
        $product1 = Product::factory()->create();
        $product2 = Product::factory()->create();
...
describe('Combo Deletion', function () {
    test('can delete combo', function () {
...
describe('Combo Status Toggle', function () {
    test('can activate or deactivate combo', function () {
...
describe('Combo Validation', function () {
    test('requires minimum 2 products in combo', function () {
        $product = Product::factory()->create();
    ...
    test('validates delivery price is greater or equal than pickup', function () {
        $product1 = Product::factory()->create();
        $product2 = Product::factory()->create();
    ...
    test('cannot activate combo with inactive products', function () {
        $activeProduct = Product::factory()->create(['is_active' => true]);
    ...
    test('validates unique name when creating combo', function () {
    ...
    test('allows same name when editing same combo', function () {
    ...
    test('validates category is combo type', function () {
        $product1 = Product::factory()->create();
        $product2 = Product::factory()->create();
