    ...
    public function run(): void
    {
        ...
        if ($variant1) {
            ...
            $promotion1->items()->create([
                ...
                'special_price_pickup_capital' => 75.00,
                'special_price_delivery_capital' => 80.00,
                'special_price_pickup_interior' => 80.00,
                'special_price_delivery_interior' => 85.00,
                'service_type' => 'both',
        ...
        if ($products->count() > 1) {
            ...
            if ($variant2) {
                ...
                $promotion2->items()->create([
                    ...
                    'special_price_pickup_capital' => 85.00,
                    'special_price_delivery_capital' => 90.00,
                    'special_price_pickup_interior' => 90.00,
                    'special_price_delivery_interior' => 95.00,
                    'service_type' => 'both',
                    'validity_type' => 'weekdays',
                    'weekdays' => [6, 7],
                ]);
        ...
        if ($products->count() > 2) {
            ...
            if ($variant3) {
                ...
                $promotion3->items()->create([
                    ...
                    'special_price_pickup_capital' => 70.00,
                    'special_price_delivery_capital' => 70.00,
                    'special_price_pickup_interior' => 75.00,
                    'special_price_delivery_interior' => 75.00,
        ...
        if ($products->count() > 3) {
            ...
            if ($variant4) {
                ...
                $promotion4->items()->create([
                    ...
                    'special_price_pickup_capital' => 65.00,
                    'special_price_delivery_capital' => 70.00,
                    'special_price_pickup_interior' => 70.00,
                    'special_price_delivery_interior' => 75.00,
                    'service_type' => 'both',
        ...
        if ($products->count() > 4) {
            ...
            if ($variant5) {
                ...
                $promotion5->items()->create([
                    ...
                    'special_price_pickup_capital' => 68.00,
                    'special_price_delivery_capital' => 73.00,
                    'special_price_pickup_interior' => 73.00,
                    'special_price_delivery_interior' => 78.00,
