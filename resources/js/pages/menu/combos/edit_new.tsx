...
function SortableItem({ item, index, products, onUpdate, onRemove, errors, canDelete }: SortableItemProps) {
    const {
        attributes,
        listeners,
        setNodeRef,
    ...
    return (
        ...
        >
            ...
            <ProductCombobox
                ...
                onChange={(value) => {
                    onUpdate(index, 'product_id', value ? String(value) : '');
                    // Reset variant cuando cambia producto
                    onUpdate(index, 'variant_id', '');
                }}
                products={products}
                label="Producto"
