...
export default function TermsIndex({ document }: TermsPageProps) {
    return (
        <AppLayout>
            ...
            <div className="mx-auto flex h-full w-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/support/terms-and-conditions/edit">
                        <Button>
                    ...
                    <CardContent className="pt-6">
                        {document?.content_html ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <Link href="/support/terms-and-conditions/edit" className="mt-4">
