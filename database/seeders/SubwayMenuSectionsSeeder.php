...
class SubwayMenuSectionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sections = [
            ...
            [
                'title' => 'Extras',
                'description' => 'Agrega extras a tu sub',
                'is_required' => false,
                'allow_multiple' => true,
                'min_selections' => 0,
                'max_selections' => 3,
                ...
                'sort_order' => 6,
                'options' => [
                    ['name' => 'Queso Extra', 'is_extra' => true, 'price_modifier' => 5.00, 'sort_order' => 1],
                    ['name' => 'Tocino', 'is_extra' => true, 'price_modifier' => 8.00, 'sort_order' => 2],
                    ['name' => 'Pepperoni', 'is_extra' => true, 'price_modifier' => 8.00, 'sort_order' => 3],
                ],
            ],
        ];
