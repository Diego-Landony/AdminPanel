...
class ManageCustomerDevicesLifecycle extends Command
{
     ...
     * @var string
     */
    protected $description = 'Gestiona el ciclo de vida de dispositivos: marca inactivos (30+ días) y elimina antiguos (360+ días)';
    ...
    public function handle(): int
    {
        ...
        // Paso 1: Marcar dispositivos como inactivos (30+ días sin uso)
        $this->info('📝 Paso 1: Marcando dispositivos inactivos (30+ días sin uso)...');
        ...
        // Paso 2: Eliminar dispositivos antiguos (360+ días sin uso) usando soft delete
        $this->newLine();
        $this->info('🗑️  Paso 2: Eliminando dispositivos antiguos (360+ días sin uso)...');
