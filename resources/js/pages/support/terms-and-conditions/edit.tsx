...
export default function EditTerms({ document, suggestedVersion, latestContent }: EditTermsPageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const url = isEditing ? `/support/terms-and-conditions/${document.id}` : '/support/terms-and-conditions';
    ...
    return (
        <AppLayout>
            <Head title={isEditing ? 'Editar Términos y Condiciones' : 'Crear Términos y Condiciones'} />

            <CreatePageLayout
                title={isEditing ? 'Editar Términos y Condiciones' : 'Nueva versión de Términos y Condiciones'}
                description="Escribe el contenido de los términos y condiciones usando el editor"
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                        <Button type="button" variant="outline" onClick={() => router.visit('/support/terms-and-conditions')}>
                            Cancelar
                        </Button>
