        ...
        $promotionData = [
            ...
            'items' => [
                [
                    ...
                    'special_price_pickup_capital' => 35.00,
                    'special_price_delivery_capital' => 35.00,
                    'special_price_pickup_interior' => 30.00,
                    'special_price_delivery_interior' => 30.00,
                    'service_type' => 'both',
        ...
        $promotionData = [
            ...
            'items' => [
                [
                    'product_id' => $product->id,
                    'category_id' => $product->category_id,
                    'special_price_pickup_capital' => 40.00,
                    'special_price_delivery_capital' => 40.00,
                    'special_price_pickup_interior' => 35.00,
                    'special_price_delivery_interior' => 35.00,
                    'service_type' => 'both',
...
describe('General Promotion Operations', function () {
    test('can edit promotion', function () {
        ...
        $promotion->items()->create([
            'product_id' => $product->id,
            'category_id' => $product->category_id,
            'special_price_pickup_capital' => 30.00,
            'special_price_delivery_capital' => 30.00,
            'special_price_pickup_interior' => 25.00,
            'special_price_delivery_interior' => 25.00,
            'service_type' => 'both',
            'validity_type' => 'weekdays',
            'weekdays' => [1],
        ]);
