...
export default function TermsIndex({ documents, published, stats }: TermsPageProps) {
    ...
    const handleDelete = () => {
        ...
        router.delete(`/support/terms-and-conditions/${selectedDoc.id}`, {
            preserveState: false,
    ...
    const handlePublish = (doc: LegalDocument) => {
        router.post(
            `/support/terms-and-conditions/${doc.id}/publish`,
            {},
            {
                preserveState: false,
                onError: (error) => {
        ...
        },
        {
            ...
            render: (doc: LegalDocument) => (
                <div className="flex items-center justify-end gap-2">
                    ...
                    <TableActions
                        editHref={`/support/terms-and-conditions/${doc.id}/edit`}
    ...
    return (
        <AppLayout>
            ...
            <SimpleTable
                ...
                description="Gestiona las versiones de los términos y condiciones de la app"
                icon={<FileText className="h-5 w-5" />}
                data={documents}
                columns={columns}
                stats={docStats}
                createUrl="/support/terms-and-conditions/create"
                createLabel="Nueva versión"
                emptyMessage="No hay versiones de términos y condiciones"
            />
