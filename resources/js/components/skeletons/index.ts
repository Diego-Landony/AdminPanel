// Universal skeleton components - Index Pages
export { DataTableSkeleton } from './DataTableSkeleton';
export { IndexPageSkeleton } from './IndexPageSkeleton';
export { MobileCardSkeleton } from './MobileCardSkeleton';

// Universal skeleton components - Create Pages
...
export { CreateSectionsSkeleton } from './create-sections-skeleton';
...
export { EditSectionsSkeleton } from './edit-sections-skeleton';
