...
class StoreBundlePromotionRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            if ($this->items) {
                ...
                // Nota: No validamos productos activos aquí - el frontend muestra advertencia
                // y el backend valida con isApplicable() al momento de aplicar la promoción
