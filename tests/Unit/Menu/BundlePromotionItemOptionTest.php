...
describe('Option Creation', function () {
    ...
    test('can create option with variant', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
...
describe('Cascade Deletion', function () {
    test('deletes in cascade when bundle item is deleted', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
        $product = Product::factory()->create();
...
describe('Sorting', function () {
    ...
    test('can set sort_order', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
        $product = Product::factory()->create();
...
describe('Validation', function () {
    test('requires product_id', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
...
describe('Multiple Variants', function () {
    test('can have multiple options of same product with different variants', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
        $product = Product::factory()->create(['has_variants' => true]);
    ...
    test('can have variants from different products', function () {
        $promotion = Promotion::factory()->create(['type' => 'bundle_special']);
