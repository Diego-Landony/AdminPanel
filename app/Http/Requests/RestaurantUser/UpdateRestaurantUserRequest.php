...
class UpdateRestaurantUserRequest extends FormRequest
{
    ...
    {
        $restaurantUserId = $this->route('restaurantUser')?->id ?? $this->route('restaurantUser');
        ...
        return [
            ...
            'email' => [
                ...
                'email',
                'max:255',
                Rule::unique('restaurant_users', 'email')->ignore($restaurantUserId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'email.unique' => 'Este correo electronico ya esta registrado por otro usuario.',
