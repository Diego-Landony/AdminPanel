...
- API JSON: `https://admin.subwaycardgt.com/docs` (NOT `/docs/api-docs.json`)
- Swagger UI: `https://admin.subwaycardgt.com/api/documentation`
- Local file: `storage/api-docs/api-docs.json`
- Flutter guide: `docs/API-FLUTTER-ANALYSIS.md`
- Do NOT try to fetch `/docs/api-docs.json` - that URL does not exist
